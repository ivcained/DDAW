        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-400">
              GridSound wants to be an open source online digital audio
              workstation following the new WebAudio API. Who wants to play
              around with https://github.com/gridsound/daw? Our 12 Stem+ Sound
              track that was recorded in Denver. These Individual Stems will be
              processed individually and a unique amount of "Sends" also known
              as the FX such as Delay, Reverb, Pitch Modulation and 50 other
              unique effects. 8:32
            </p>
          </div>
